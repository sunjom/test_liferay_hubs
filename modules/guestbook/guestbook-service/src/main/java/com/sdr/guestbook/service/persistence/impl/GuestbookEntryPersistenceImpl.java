...
import com.sdr.guestbook.service.persistence.impl.constants.sdrPersistenceConstants;
...
public class GuestbookEntryPersistenceImpl
	...
	@Override
	@Reference(
		target = sdrPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = sdrPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
